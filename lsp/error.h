...
public:
	RequestError(const std::string& message, ErrorCodes code, std::optional<json::Any> data = std::nullopt) :
		Error{message, code, std::move(data)}{}
	RequestError(const std::string& message, LSPErrorCodes code, std::optional<json::Any> data = std::nullopt) :
		Error{message, code, std::move(data)}{}
};
...
public:
	ResponseError(const std::string& message, ErrorCodes code, std::optional<json::Any> data = std::nullopt) :
		Error{message, code, std::move(data)}{}
	ResponseError(const std::string& message, LSPErrorCodes code, std::optional<json::Any> data = std::nullopt) :
		Error{message, code, std::move(data)}{}
};
